...
\subsection{Adatok továbbküldése a számítógépre}
...
\subsubsection{Universal Serial Bus (USB)\cite{usb-article-1,usb-article-2,usb-article-3}}
...
\begin{itemize}
    ...
    \item Root Hub: hardweres elem, ami belépési pontot biztosít, vagy root-ot az USB hierachiának a host rendszeren. 
\end{itemize}
...
Az USB végpontok egyirányúak és az adat csak olyan irányba áramolhat, amelyet a végpont megenged. leggyakrabban ciklikus reduncancia vizsgálatot használnak a hibák keresésére (Cyclic Redundancy Checks - CRC). Ez a módszer checksum számítás követően hozzáadja a csomaghoz ezt az értéket, majd a fogadó fél újra kiszámolja a checksumot, amennyiben a két checksum egyezik, sikeres volt az adatátvitel.
...
\subsubsection{A report descriptor fogalma}
\begin{quote}
...
\end{quote}\cite{customising-devices,custom-hid}
